...
from experiment_utils.wordnet import minimise_sparse_productwise
...
if __name__ == "__main__":
    ...
    for _ in range(NREPS):
        ...
        for experiment in experiments:
            output = minimise_sparse_productwise(
                subkey,
                relations=data,
    ...
    with open(dir_name + "/noburnin_mammals_productwise.pkl", "wb") as f:
